...
export class Domain {
  ...
  /** AUTH */
  get CreateTokenAuthUseCase() {
    return this.#getter<CreateTokenAuthUseCaseInput, AuthTokens>(
      async () => import('./auth/UseCases/CreateTokenAuthUseCase.js'),
      'CreateTokenAuthUseCase'
    )
  } // eslint-disable-line

  get VerifyRefreshTokenAuthUseCase() {
    return this.#getter<VerifyRefreshTokenAuthUseCaseInput, AuthTokens>(
      async () => import('./auth/UseCases/VerifyRefreshTokenAuthUseCase.js'),
      'VerifyRefreshTokenAuthUseCase'
    )
  } // eslint-disable-line

  get RemoveUserTokenAuthUseCase() {
    return this.#getter<RemoveUserTokenAuthUseCaseInput, AuthTokens>(
      async () => import('./auth/UseCases/RemoveUserTokenAuthUseCase.js'),
      'RemoveUserTokenAuthUseCase'
    )
  } // eslint-disable-line

  /** User */
  get FindByIDUserUseCase() {
    return this.#getter<FindByIDUserUseCaseInput, User>(
      async () => import('./user/UseCases/FindByIDUserUseCase.js'),
      'FindByIDUserUseCase'
    )
  } // eslint-disable-line

  get FindOneUserUseCase() {
    return this.#getter<FindOneUserUseCaseInput, User>(
      async () => import('./user/UseCases/FindOneUserUseCase.js'),
      'FindOneUserUseCase'
    )
  } // eslint-disable-line
  ...
  get VerifyEmailAndPasswordUserUseCase() {
    return this.#getter<VerifyEmailAndPasswordUserUseCaseInput, User>(
      async () => import('./user/UseCases/VerifyEmailAndPasswordUserUseCase.js'),
      'VerifyEmailAndPasswordUserUseCase'
    )
  } // eslint-disable-line
  ...
  get GetAllBookUseCase() {
    return this.#getter<GetAllBookUseCaseInput, Books>(
      async () => import('./book/UseCases/GetAllBookUseCase.js'),
      'GetAllBookUseCase'
    )
  } // eslint-disable-line
  ...
  get FindByIDChapterUseCase() {
    return this.#getter<FindByIDChapterUseCaseInput, Chapters>(
  ...
  get CreateLinkUseCase() {
    return this.#getter<CreateLinkUseCaseInput, Link | DomainError>(
  ...
  get RemoveByIDLinkUseCase() {
    return this.#getter<RemoveByIDLinkUseCaseInput, Links>(
      async () => import('./link/UseCases/RemoveByIDLinkUseCase.js'),
      'RemoveByIDLinkUseCase'
    )
  } // eslint-disable-line

  get RemoveByChapterIDLinkUseCase() {
    return this.#getter<RemoveByChapterIDLinkUseCaseInput, Links>(
      async () => import('./link/UseCases/RemoveByChapterIDLinkUseCase.js'),
      'RemoveByChapterIDLinkUseCase'
    )
  } // eslint-disable-line

  /** Body */
  get AddBodyUseCase() {
    return this.#getter<AddBodyUseCaseInput, Body>(
      async () => import('./body/UseCases/AddBodyUseCase.js'),
      'AddBodyUseCase'
    )
  } // eslint-disable-line

  get FindByIDBodyUseCase() {
    return this.#getter<FindByIDBodyUseCaseInput, Body>(
      async () => import('./body/UseCases/FindByIDBodyUseCase.js'),
      'FindByIDBodyUseCase'
    )
  } // eslint-disable-line

  get GetAllBodyUseCase() {
    return this.#getter<GetAllBodyUseCaseInput, Bodies>(
      async () => import('./body/UseCases/GetAllBodyUseCase.js'),
      'GetAllBodyUseCase'
    )
  } // eslint-disable-line

  get FindByHashBodyUseCase() {
    return this.#getter<FindByHashBodyUseCaseInput, Bodies>(
      async () => import('./body/UseCases/FindByHashBodyUseCase.js'),
      'FindByHashBodyUseCase'
    )
  } // eslint-disable-line

  get RemoveByChapterIDBodyUseCase() {
    return this.#getter<RemoveByChapterIDBodyUseCaseInput, Bodies>(
      async () => import('./body/UseCases/RemoveByChapterIDBodyUseCase.js'),
      'RemoveByChapterIDBodyUseCase'
    )
  } // eslint-disable-line
