...
export class BookCover {
  static create({id, userID, bookID, key, createdAt, updatedAt}: z.infer<typeof BookCoverValidations>) {
    BookCoverValidations.parse({id, userID, bookID, key, createdAt, updatedAt})
    return new BookCover(id, userID, bookID, key, createdAt ?? TimeStamp.now(), updatedAt ?? TimeStamp.now(), false)
  }

  static empty() {
    return new BookCover(undefined, undefined, undefined, undefined, undefined, undefined, true)
  }
