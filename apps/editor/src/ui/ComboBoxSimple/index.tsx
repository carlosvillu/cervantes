...
export const ComboBoxSimple: FC<{
  name: string
  label: string
  items: Item[]
  defaultItem: Item
  onChange?: (id: Item['id']) => void
}> = ({name, label, items, defaultItem, onChange}) => {
  const [query, setQuery] = useState('')
  const [selectedPerson, setSelectedPerson] = useState(defaultItem)
  ...
  return (
    <>
      <input type="hidden" name={name} id={name} value={selectedPerson.id} />
      <Combobox
        as="div"
