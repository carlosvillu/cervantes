...
export class Domain {
  ...
  get GetRootChapterUseCase() {return this.#getter<GetRootChapterUseCaseInput, Chapter>(async () => import('./chapter/UseCases/GetRootChapterUseCase.js'),'GetRootChapterUseCase')} // eslint-disable-line
